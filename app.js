...
var model = 'https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/c413b2ef-382c-45bd-8ff0-f76d60e2a821?subscription-key=f31bbca73cea44beba24bc1368673129&q=';
...
dialog.onDefault(
    function(session){
        var card = new builder.HeroCard(session)
            .title("CCW_BOT")
            .text("your bots")
            .images([builder.CardImage.create(session, "https://scontent.fagc1-2.fna.fbcdn.net/v/t31.0-8/15875389_1826804247531087_2105178672617196130_o.jpg?oh=260e58c24141a58ff22c05f456d997a2&oe=591C060B")]);
